...
$products = $conn->query("SELECT * FROM products WHERE category='Unisex' ORDER BY id ASC");
?>
...
<head>
    ...
    <title>Unisex - New Dawn Thrift</title>
...
<main class="products-main">
    ...
    <aside class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a href="product4.php">Unisex</a></li>
        </ul>
        <p style="margin-top: 20px; font-size: 14px;">Welcome to Unisex Section! Styles for everyone.</p>
    </aside>
