...
$products = $conn->query("SELECT * FROM products WHERE category='Womens' ORDER BY id ASC");
?>
...
<title>Womens - New Dawn Thrift</title>
<link rel="stylesheet" href="products.css?v=5">
...
<main class="products-main">
    ...
    <aside class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a href="product2.php">Womens</a></li>
            <li><a href="product3.php">Kids</a></li>
            <li><a href="product4.php">Unisex</a></li>
        </ul>
        <p class="sidebar-message">Welcome to Womens Section! Find your next favorite fit.</p>
    </aside>
